...
import { Button, Modal, Spinner, Alert } from "@themesberg/react-bootstrap";
...
export default ({ id, setReload }) => {
  ...
  const handleClick = (e) => {
    ...
    Axios({
      method: "DELETE",
      url: `${process.env.REACT_APP_PARTNER_API}/awards/${id}`,
      headers: {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Modal.Body>
          <div>Are you sure you want to delete this aword?</div>

      ...
      >
          ...
          <>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Select
                ...
                onChange={(d) =>
                  onChangeValue({ ...formValues, orderStatus: d.target.value })
                }
              >
                {/* not cool */}
                ...
                <option>Enroute to customer</option>
        ...
        <Modal.Footer>
          ...
          >
            ...
            {!loadingStatus ? `Update Status` : <Spinner animation="border" size="sm" />}
          </Button>
        </Modal.Footer>
      </Modal>
    </React.Fragment>
